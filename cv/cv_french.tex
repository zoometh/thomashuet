...
\textbf{2000-02 } Maîtrise Archaeology (Master 1 Archaeology), Université Paris IV, Paris-Sorbonne, Paris.
\textbf{1999-2000 } Licence Archaeology, Université Paris IV, Paris-Sorbonne, Paris.
...
\subsubsection*{Administrative responsabilities}

- \href{https://researchsupport.admin.ox.ac.uk/oasg}{Open Access Steering Group (OASG)}: Representant of the researchers at the university level, University of Oxford} (2023-...)\\ 
- \href{https://spectra.arch.ox.ac.uk/}{Society for Postdoctoral and Early Career Teaching and Research Staff in Archaeology (SPECTRA)}: Treasurer\\ 
- \href{https://iris.anr.fr/}{expert Agence Nationale pour la Recherche (ANR)}

\subsubsection*{Collective research projects}

\textbf{Member of}:

- \href{https://eamena.org/}{\textit{Endangered Archaeology in the Middle East and North Africa} (EAMENA) management committee project}
