...
% Continue in this pattern for the rest of the entries
...
\textbf{2023 }
\fr{\href{https://eamena.org/advanced-use}{\includegraphics[scale=0.02]{link_darkblue.png}} Base de données EAMENA Utilisation Avancée. Métadonnées, visualisation de graphiques (CIDOC-CRM), modèle conceptuel de données, etc.}
\en{\href{https://eamena.org/advanced-use}{\includegraphics[scale=0.02]{link_darkblue.png}} EAMENA database Advanced Use. Metadata, graph visualization (CIDOC-CRM), conceptual data model, etc.}
\smallbreak
\textbf{2022 }
...
\en{\href{http://shinyserver.cfs.unipi.it:3838/C14/}{\includegraphics[scale=0.03]{prj_neonet-blue.png}} Interactive \textsf{RShiny} web application NeoNet, stable version. Selection, calibration, accumulation, and on-the-fly modeling of radiocarbon dates from the final Mesolithic/early Neolithic transition in the central north-western Mediterranean basin.}
\smallbreak
\textbf{--- }
...
\textbf{2024 }
\fr{"Neural Networks for Archaeologists, with \textsf{Python}", Department of Civilisations and Forms of Knowledge of the Università di Pisa, Italy, en ligne, 18-28 Juin \href{https://www.unipi.it/index.php/humanities/item/26801-neural-networks-archaeologists-python}{\includegraphics[scale=0.02]{link_darkblue.png}}.}
\en{"Neural Networks for Archaeologists, with \textsf{Python}", Department of Civilisations and Forms of Knowledge of the University of Pisa, Italy, online, June 18-28 \href{https://www.unipi.it/index.php/humanities/item/26801-neural-networks-archaeologists-python}{\includegraphics[scale=0.02]{link_darkblue.png}}.}
...
\smallbreak
\textbf{2022 }
\fr{"\textsf{R} useR 2022 - Docker for R Workshop", R Foundation, en ligne, 20 Juin \href{https://github.com/rsangole/user2022-r-for-docker}{\includegraphics[scale=0.02]{link_darkblue.png}}.}
\en{"\textsf{R} useR 2022 - Docker for R Workshop", R Foundation, online, June 20 \href{https://github.com/rsangole/user2022-r-for-docker}{\includegraphics[scale=0.02]{link_darkblue.png}}.}
...
\textbf{2018 }
\fr{"MOSAIC${}^{NET\ }$2018: Networks in Archaeological Research", International Summer School at Bibracte, Ecole Europ\'{e}enne de Protohistoire (Glux-en-Glenne, France), 8-12 Octobre \href{https://www.ufg.uni-kiel.de/en/news_expired/events-ufg/conferences-exhibitions/mosaic-2018}{\includegraphics[scale=0.02]{link_darkblue.png}}.}
\en{"MOSAIC${}^{NET\ }$2018: Networks in Archaeological Research", International Summer School at Bibracte, European School of Protohistory (Glux-en-Glenne, France), October 8-12 \href{https://www.ufg.uni-kiel.de/en/news_expired/events-ufg/conferences-exhibitions/mosaic-2018}{\includegraphics[scale=0.02]{link_darkblue.png}}.}
...
\textbf{2022}
\fr{Representing Historical Time \href{https://github.com/historical-time}{\includegraphics[scale=0.02]{link_darkblue.png}}}
\en{Representing Historical Time \href{https://github.com/historical-time}{\includegraphics[scale=0.02]{link_darkblue.png}}}

\textbf{--- }
\fr{Projet CENTAURO: "Equid introduction, hybridisation and agricultural intensification in the Ebro valley from the Late Neolithic to the Iron Age" (2022-2025) \href{https://www.centaur-o.com/}{\includegraphics[scale=0.02]{link_darkblue.png}}}
\en{CENTAURO Project: "Equid introduction, hybridisation and agricultural intensification in the Ebro valley from the Late Neolithic to the Iron Age" (2022-2025) \href{https://www.centaur-o.com/}{\includegraphics[scale=0.02]{link_darkblue.png}}}

\textbf{2021 - ...}
\fr{Comité de gestion du projet EAMENA \href{https://eamena.org/}{\includegraphics[scale=0.02]{link_darkblue.png}}}
\en{EAMENA Project Management Committee \href{https://eamena.org/}{\includegraphics[scale=0.02]{link_darkblue.png}}}

\textbf{2021}
\fr{ANRJCC Itineris \href{https://anr.fr/Project-ANR-21-CE27-0010}{\includegraphics[scale=0.02]{link_darkblue.png}}}
\en{ANRJCC Itineris \href{https://anr.fr/Project-ANR-21-CE27-0010}{\includegraphics[scale=0.02]{link_darkblue.png}}}

\textbf{2020}
\fr{Groupe d'intérêt spécial sur les langages de script scientifiques en archéologie (\textit{Special Interest Group on Scientific Scripting Languages in Archaeology}, SIG-SSLA) \href{https://sslarch.github.io/}{\includegraphics[scale=0.02]{link_darkblue.png}}}
\en{Special Interest Group on Scientific Scripting Languages in Archaeology (SIG-SSLA) \href{https://sslarch.github.io/}{\includegraphics[scale=0.02]{link_darkblue.png}}}

\textbf{2020}
\fr{Groupe d'archéologie de haute montagne (\textit{Grup d'Arqueologia de l'Alta Muntanya}, GAAM), Universitat Autònoma de Barcelona et Consejo Superior de Investigaciones Cientificas (UAB-CSIC) \href{https://arqueologiademuntanya.wordpress.com/}{\includegraphics[scale=0.02]{link_darkblue.png}}}
\en{High Mountain Archaeology Group (\textit{Grup d'Arqueologia de l'Alta Muntanya}, GAAM), Autonomous University of Barcelona and Spanish National Research Council (UAB-CSIC) \href{https://arqueologiademuntanya.wordpress.com/}{\includegraphics[scale=0.02]{link_darkblue.png}}}

\textbf{2020}
\fr{Projet collectif de recherche \textit{NeoNet}(2020-...) \href{https://redneonet.com/}{\includegraphics[scale=0.02]{link_darkblue.png}}}
\en{NeoNet Research Collective Project (2020-...) \href{https://redneonet.com/}{\includegraphics[scale=0.02]{link_darkblue.png}}}
...
\textbf{2023}
\fr{Représentant des chercheurs (niveau Université) - Groupe de pilotage sur le libre accès (\textit{Open Access Steering Group}, OASG), Université d'Oxford (2023-...) \href{https://researchsupport.admin.ox.ac.uk/oasg}{\includegraphics[scale=0.02]{link_darkblue.png}}}
\en{Researcher Representative (University Level) - Open Access Steering Group (OASG), University of Oxford (2023-...) \href{https://researchsupport.admin.ox.ac.uk/oasg}{\includegraphics[scale=0.02]{link_darkblue.png}}}

\textbf{2023}
\fr{Trésorier - Société pour le personnel enseignant et de recherche postdoctoral et en début de carrière en archéologie (\textit{Society for Postdoctoral and Early Career Teaching and Research Staff in Archaeology}, SPECTRA) \href{https://spectra.arch.ox.ac.uk/}{\includegraphics[scale=0.02]{link_darkblue.png}}}
\en{Treasurer - Society for Postdoctoral and Early Career Teaching and Research Staff in Archaeology (SPECTRA) \href{https://spectra.arch.ox.ac.uk/}{\includegraphics[scale=0.02]{link_darkblue.png}}}

\textbf{2023}
\fr{Expert - Agence Nationale pour la Recherche (ANR) \href{https://iris.anr.fr/}{\includegraphics[scale=0.02]{link_darkblue.png}}}
\en{Expert - French National Research Agency (ANR) \href{https://iris.anr.fr/}{\includegraphics[scale=0.02]{link_darkblue.png}}}
...
\textbf{-}
\fr{Relecteur pour: \textit{ArcheoLogica-Data} journal (2022-...), \textit{Journal of Open Source Software} (2021-...), \textit{Journal of Computer Applications for Archaeology} (2021-...) et \textit{CAA Review College} (2014-...), \textit{Bulletin de la Société Préhistorique Française} journal (2020-...), \textit{M@ppemonde} journal (2019-...)}
\en{Reviewer for: \textit{ArcheoLogica-Data} journal (2022-...), \textit{Journal of Open Source Software} (2021-...), \textit{Journal of Computer Applications for Archaeology} (2021-...) and \textit{CAA Review College} (2014-...), \textit{Bulletin de la Société Préhistorique Française} journal (2020-...), \textit{M@ppemonde} journal (2019-...)}
...
\smallbreak
\textbf{---}
\fr{"Initiation aux statistiques", MASTER parcours Géo-bioarchéo, \textit{TW223AH Atelier traitement des données}, Université de Montpellier, 20-22 Février (6 heures), \href{http://shinyserver.cfs.unipi.it:3838/teach/stats/upv/_site/#/title-slide}{\includegraphics[scale=0.02]{link_darkblue.png}}.}
\en{"Introduction to Statistics", MASTER in Geo-bioarchaeology, \textit{TW223AH Data Processing Workshop}, University of Montpellier, February 20-22 (6 hours), \href{http://shinyserver.cfs.unipi.it:3838/teach/stats/upv/_site/#/title-slide}{\includegraphics[scale=0.02]{link_darkblue.png}}.}

\smallbreak
\textbf{---}
\fr{"Report with R Markdown", Winter School 'R 4 Archeologists', \textit{Progetto metodologie applicate all predittivita del potenziale archeologico} (mappa), Università di Pisa, 8 Février (3 heures), \href{https://github.com/zoometh/thomashuet/tree/main/teach/stats/r4a}{\includegraphics[scale=0.02]{link_darkblue.png}}.}
\en{"Report with R Markdown", Winter School 'R 4 Archaeologists', \textit{Project on Applied Methodologies for Predictive Archaeological Potential} (mappa), University of Pisa, February 8 (3 hours), \href{https://github.com/zoometh/thomashuet/tree/main/teach/stats/r4a}{\includegraphics[scale=0.02]{link_darkblue.png}}.}
