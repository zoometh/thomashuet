...
\textbf{2025 }
\fr{"Visualisation de données avancées avec Python", IFSeM, Délégation Ile-de-France Villejuif et Service Mutualisé en Ile-de-France, 4-5 Décembre.}
\en{"Advanced Data Visualization with Python", IFSeM, Délégation Ile-de-France Villejuif and Service Mutualisé en Ile-de-France, December 4-5.}
\smallbreak

\textbf{2025 }
\fr{"Visualisation de données avancées avec Python", IFSeM, Délégation Ile-de-France Villejuif et Service Mutualisé en Ile-de-France, 4-6 Décembre}
\en{"Advanced Data Visualization with Python", IFSeM, Délégation Ile-de-France Villejuif and Service Mutualisé en Ile-de-France, December 4-6}
\smallbreak

\textbf{2025 }
\fr{"PyMoDAQ - Instrumentation en Python : utilisation et écriture de Plugin instruments", CNRS Entreprises, 1-2 Décembre}
\en{"PyMoDAQ - Instrumentation in Python : usage and writing of instrument plugins", CNRS Entreprises, 1-2 December}
\smallbreak
