...
%\end{itemize}
\fr{\textbf{Thomas Huet}}\en{\textbf{Dr. Thomas Huet}} \\

\smallbreak
% \smash{\includegraphics[width=3.5cm, right]{id-s}}
\includegraphics[scale=0.010]{webpro} \quad \href{https://iramat.cnrs.fr/user/thomas.huet/}{CNRS}\\
...
\includegraphics[scale=0.025]{gmail} \quad \url{mailto:thomas.huet@cnrs.fr}\\
\includegraphics[scale=0.025]{gmail} \quad \url{mailto:thomas-s.huet@cea.fr}\\
\includegraphics[scale=0.025]{gmail} \quad \url{mailto:thomas.huet@arch.ox.ac.uk}\\
\includegraphics[scale=0.025]{gmail} \quad \url{mailto:thomashuet7@gmail.com}\\
\includegraphics[scale=0.005]{phone} \quad  +33 (0)6 70 54 88 31 \\
\includegraphics[scale=0.005]{phone} \quad  +44 (0)7 518 152 642 \\

% non affiché
\ar{Thomas Huet est ingénieur de recherche au CNRS. Il a travaillé dans des domaines très variés, en plaçant au centre de son activité la gestion de l'information archéologique, notamment à travers l'infrastructuration (administration système, architecture client-serveur, bases de données), l'interopérabilité (API, thésaurus, ontologies, métadonnées) et la modélisation (analyse de réseaux, statistiques). En lien avec plusieurs universités et centres de recherche internationaux, Thomas participe au développement de l’archéologie computationnelle en Europe depuis plus de 15 ans, y compris dans ses développements les plus récents avec l'intelligence artificielle. Il a publié plusieurs articles de recherche et de données de rang A, développé du code informatique et mis en ligne de nombreuses applications interactives liées à l’archéologie.
}

\section{\fr{SITUATION ACTUELLE (depuis 2025)}\en{CURRENT SITUATION (since 2025)}}
%\begin{itemize}
\fr{\textbf{Ingénieur de Recherche CNRS}}\en{\textbf{Research Engineer CNRS}}, IRAMAT-UMR7065, site CEA de Saclay, bâtiment 637, 91191 Gif-sur-Yvette cedex, France.

\section{\fr{POSTES ACADÉMIQUES \textit{\&} PROFESSIONNELS (depuis 2013)}\en{ACADEMIC \textit{\&} PROFESSIONAL POSITIONS (since 2013)}}

\textbf{2021-5} 
\fr{Chercheur et responsable base de données (\textit{Researcher and Database Manager}), projet EAMENA (\textit{Endangered Archaeology in the Middle East and North Africa}), Université d'Oxford, School of Archaeology, 2 South Parks Road, Oxford OX1 3TG, Royaume-Uni, novembre 2021-février 2025\\
...
\en{Researcher and Database Manager for EAMENA (\textit{Endangered Archaeology in the Middle East and North Africa}), University of Oxford, School of Archaeology, 2 South Parks Road, Oxford OX1 3TG, United Kingdom, November 2021- January 2025\\
...
\textbf{2024-6}
\fr{Membre du comité consultatif du projet "Practical Mariner" (2024-2026), dir. Dr. Linda Hulin, chool of Archaeology, University of Oxford}
\en{Member of the "Practical Mariner" project (2024-6) Advisory Board, dir. Dr. Linda Hulin, School of Archaeology, University of Oxford}
...
$\bullet$ Pasqualini A., \textbf{Huet T.} et M.-J. Ouriachi ({\textbf{2026}}). Une base de données informatique dédiée au programme Epispat, \textit{in} Ouriachi M.-J. et Pellecuer C. (eds), \textit{Actes de la Table-ronde de cl\^{o}ture du programme Epispat, 21-22 nov. 2019, Hi\'{e}rarchie sociale et d\'{e}veloppement territorial en Gaule Narbonnaise et dans les provinces voisines : enqu\^{e}tes au croisement de l'\'{e}pigraphie et de l'arch\'{e}ologie spatiale}, Revue Arch\'{e}ologique de Narbonnaise.
\smallbreak
$\bullet$ \textbf{Huet T.} et Levy E., (\textbf{2025}). Foreword - Archaeometry special issue on chronological modeling, \textit{Archaeometry}, DOI:  DOI: \href{https://doi.org/10.1111/arcm.13095}{10.1111/arcm.13095}. 
\smallbreak
...
\smallbreak
$\bullet$ \textbf{Huet T.} (\textbf{2026}). From Contextual Seriation to Regional Chronology: A Modular Heuristic Approach. Peer Community in Archaeology, 100712. DOI: \href{https://doi.org/10.24072/pci.archaeo.100712}{10.24072/pci.archaeo.100712} 
\smallbreak
$\bullet$ \textbf{Huet T.} and Burke A. (\textbf{2026}). Toward Reproducible Machine Learning-Based Provenance Analysis of Chalcolithic Variscite. Peer Community in Archaeology, 100676. DOI: \href{https://doi.org/10.24072/pci.archaeo.100676}{10.24072/pci.archaeo.100676} 
\smallbreak
$\bullet$ \textbf{Huet T.} (\textbf{2026}). Approaches to Uncertainty in Archaeological Linked Open Data within NFDI4Objects. Peer Community in Archaeology, 100634. DOI: \href{https://doi.org/10.24072/pci.archaeo.100634}{10.24072/pci.archaeo.100634} 
\smallbreak
$\bullet$ \textbf{Huet T.} (\textbf{2025}). Deep Learning Outperforms Geometric Morphometrics for Archaeobotanical Seed Classification. Peer Community in Archaeology, 100502. DOI: \href{https://doi.org/10.24072/pci.archaeo.100502}{10.24072/pci.archaeo.100502} 
\smallbreak
...
\subsubsection*{\fr{Vulgarisation}\en{Popularization}}

$\bullet$ \textbf{Huet T.} (\textbf{2025}). Au pays des Merveilles. in Les grands sites de l'art néolithique, Dossiers d'Archéologie, 428, Mars-Avril 2025. 
 

\subsection*{\fr{Ouvrages}\en{Books}}

\smallbreak
$\bullet$ \textbf{Huet T.}, Levy E. (Eds) (\textbf{2025}). \textit{Special issue on Chronological modelling}, Archaeometry, Volume67, Issue S1, DOI: https://doi.org/10.1111/arcm.13110.
...
$\bullet$ \textbf{Huet T.} et N. Bianchi (\textbf{2025}). Le Mont Bégo, in Marcigny C. et Mordant C. (eds), \textit{L'âge du Bronze en France, (2500 à 800 avant notre ère), volume 2, synthèses thématiques}, Paris: Inrap / Presses du CNRS, p. 390-391.
\smallbreak
...
\section*{\fr{RESPONSABILITES ADMINISTRATIVES \textit{\&} DE RECHERCHE}\en{ADMINISTRATIVE \textit{\&} RESEARCH RESPONSABILITIES}}
\smallbreak
\textbf{2025-6}
\fr{Coordinateur du Groupe de travail "Bases de données et référentiels" du réseau CAI-RN (Compétences Archéométriques Interdisciplinaires – Réseau National, MITI-CNRS)}
\en{Coordinator of the "Bases de données et référentiels" Working Group of the CAI-RN network (Interdisciplinary Archaeometric Skills – National Network, MITI-CNRS).}
\smallbreak
\textbf{2025}
\fr{Correspondant Sécurité des Systèmes Informatiques au Laboratoire des Archéomatériaux et Prévision de l'Altération (LAPA), site CEA de Saclay, bâtiment 637,Gif-sur-Yvette, France}
\en{IT Systems Security Correspondent at the Laboratory for Archaeomaterials and Alteration Forecasting (LAPA), CEA Saclay site, Building 637, Gif-sur-Yvette, France.}
...
\textbf{2026 }
\fr{"Statistiques Bayésiennes - STATS BAYES 2026", Action Nationale de Formation, CNRS, 23-26 Septembre.}
\en{"Bayesian Statistics - STATS BAYES 2026", Action Nationale de Formation, CNRS, September 23-26.}
\smallbreak

\textbf{2025 }
\fr{"Visualisation de données avancées avec Python", IFSeM, Délégation Ile-de-France Villejuif et Service Mutualisé en Ile-de-France, Paris, 4-5 Décembre.}
\en{"Advanced Data Visualization with Python", IFSeM, Délégation Ile-de-France Villejuif and Service Mutualisé en Ile-de-France, Paris, December 4-5.}
\smallbreak

\textbf{2025 }
\fr{"PyMoDAQ - Instrumentation en Python : utilisation et écriture de Plugin instruments", CNRS Entreprises, Paris, 1-2 Décembre.}
\en{"PyMoDAQ - Instrumentation in Python : usage and writing of instrument plugins", CNRS Entreprises, Paris, December 1-2.}
\smallbreak

\textbf{2025 }
\fr{"Concevoir une interface graphique en Python", IFSeM, Délégation Ile-de-France Villejuif et Service Mutualisé en Ile-de-France, Paris, 24-26 Novembre.}
\en{"Designing Graphical Interfaces in Python", IFSeM, Délégation Ile-de-France Villejuif and Service Mutualisé en Ile-de-France, Paris, November 24-26.}
\smallbreak

\textbf{2025 }
\fr{"QuantX libre - Quantification élémentaire par spectroscopie de fluorescence de rayons X", Action Nationale de Formation, CNRS, 15-17 Juin}
\en{"QuantX libre - Elemental Quantification by X-ray Fluorescence Spectroscopy", Action Nationale de Formation, CNRS, 15-17 June}
\smallbreak
...
\subsection*{\fr{Langages de programmation / Logiciels / Apprentissage machine}\en{Programming Languages / Software / Machine Learning}}

\textbf{2025 }
\fr{"Visualisation de données avancées avec Python", Formations du Service Mutualisé d'Île de France (IFSeM), 4-5 Décembre}
\enfr{"Visualisation de données avancées avec Python", Formations du Service Mutualisé d'Île de France (IFSeM), 4-5 December}
\smallbreak

\textbf{2025 }
\fr{"PyMoDAQ - Instrumentation en Python : utilisation et écriture de Plugin instruments", CNRS Formation Entreprises, 1-2 Décembre}
\enfr{"PyMoDAQ - Instrumentation en Python : utilisation et écriture de Plugin instruments", CNRS Formation Entreprises, 1-2 December}
\smallbreak

\textbf{2025 }
\fr{"Concevoir une interface graphique en Python", Formations du Service Mutualisé d'Île de France (IFSeM), 24-26 Novembre}
\enfr{"Concevoir une interface graphique en Python", Formations du Service Mutualisé d'Île de France (IFSeM), 24-26 November}
\smallbreak

\textbf{2025 }
\fr{"Quantification élémentaire par spectroscopie de fluorescence de rayons X avec le logiciel PyMca", ANF MITI Réseau CA-IRN, CNRS, 16 Juin}
\en{"Quantification élémentaire par spectroscopie de fluorescence de rayons X avec le logiciel PyMca", ANF MITI Réseau CA-IRN, CNRS, 16 June}
\smallbreak
...
\textbf{2025 }
\fr{" Quantification élémentaire par spectroscopie de fluorescence de rayons X avec le logiciel PyMca", ANF MITI Réseau CA-IRN - QuantXlibre (Paris, France), 16-7 Juin.}
\en{"Elemental quantification by X-ray fluorescence spectroscopy with PyMca software", ANF MITI Réseau CA-IRN - QuantXlibre (Paris, France), 16-7 June.}
