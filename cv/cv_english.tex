...
\large{\textbf{Thomas HUET}} PhD, Associate Researcher \\
UMR 5140 ASM-CNRS, Universit\'{e} Paul-Val\'{e}ry Montpellier 3, France \\
...
\textbf{2020 }Responsible of the survey of the medieval engravings of Sauri (Catalonia, Spain), 2${}^{nd\ }$campaign, Universitat Aut\'{o}noma de Barcelona (UAB), Spain, 19 October ---24 October.
\smallbreak
...
\smallbreak
\textbf{2019 }Responsible of the survey of the medieval engravings of Sauri (Catalonia, Spain), 1${}^{st\ }$campaign, Universitat Aut\'{o}noma de Barcelona (UAB), Spain, 15 September---15 October.
\smallbreak
...
\subsection*{Scientific Conferences and seminars (2014-)}
...
\smallbreak
\textbf{2014 }\href{https://www.oxbowbooks.com/dbbc/caa2014-21st-century-archaeology.html/}{OH-FET application v.1}, a \textsf{Python} app to compare urban dynamics over long time spans (with Ludovic Granjon and Laure Saligny, MSH de l'Université de Bourgogne).
...
\smallbreak
\textbf{2021 }\href{https://zoometh.github.io/C14/neonet/}{\includegraphics[scale=0.04]{neonet}} tutorial webpage. 
\smallbreak
...
\section{ACADEMIC \textit{\&} RESEARCH PROGRAMS (2014-20)}
...
\textsf{Sweave} (\textsf{R} + \LaTeX), \textsf{Rmarkdown}, \textsf{RShiny}, \textsf{Plotly}, \textsf{Leaflet} \textbf{{\textbar}} RPubs, Zenodo
