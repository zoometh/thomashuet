...
<span class="r-md">R Markdown</span> is an authoring framework for data science (AFDS). It combines : 
...
::: {.callout-note}
R Markdown = `.Rmd` =  <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-prg-r.png' style='height: 45px;vertical-align: middle;'> + <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-pao-markdown.png' style='height: 45px;vertical-align: middle;'> for Markdown
:::
...
A Quarto document (`.qmd`) using reveal.js (JavaScript) hosted on GitHub ([here](https://github.com/zoometh/thomashuet/blob/main/teach/stats/r4a/2024/index.qmd))
...
* <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-pao-latex.png' style='height: 45px;vertical-align: middle;'> writing and <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-pao-bibtex.png' style='height: 45px;vertical-align: middle;'> bibliographic references 
* interactive maps, 3D plots, etc.

### Ubiquity of Markdown



| Column 1       | Column 2       |
| -------------- | -------------- |
| XXX | <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-pao-markdown-ex-arches-forum' style='height: 45px;vertical-align: middle;'> |
| <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-pao-markdown-ex-github-readme.png' style='height: 45px;vertical-align: middle;'> | <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-pao-markdown-ex-chatgpt.png' style='height: 45px;vertical-align: middle;'> |
...
<tbody>
  <tr>
    <td><img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/r-pkg-knitr.png' style='width: 150px;vertical-align: middle;'></td>
    <td>[knitr](https://yihui.org/knitr/) engine for dynamic report generation with R (e.g. convert to LaTeX)</td>
  </tr>
  <tr>
    <td><img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-prg-r-pkg-rmarkdown.png' style='width: 150px;vertical-align: middle;'></td>
    ...
    <tr>
    <td><img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/r-pkg-bookdown.png' style='width: 150px;vertical-align: middle;'></td>
...
Options (`Title`, `Author`, `Date`, etc.) can be changed later ([YAML header](#yaml)). Choose **PDF** as the default output format.
...
<tbody>
  <tr>
    <td>![](https://raw.githubusercontent.com/zoometh/thomashuet/master/teach/www/rmd_nav_knitOnSave.png){width="60px"}</td>
    <td>knit automatically when save the document</td>
  </tr>
  <tr>
    <td>![](https://raw.githubusercontent.com/zoometh/thomashuet/master/teach/www/rmd_nav_checkSpelling.png){width="60px"}</td>
    <td>check spelling</td>
  </tr>
  <tr>
    <td>![](https://raw.githubusercontent.com/zoometh/thomashuet/master/teach/www/rmd_nav_knit.png){width="60px"}</td>
    <td>knit the document</td>
  </tr>
  <tr>
    <td>![](https://raw.githubusercontent.com/zoometh/thomashuet/master/teach/www/rmd_nav_mdFormatOpt.png){width="60px"}</td>
    <td>run Visual R Markdown + other options</td>
  </tr>
  <tr>
    <td>![](https://raw.githubusercontent.com/zoometh/thomashuet/master/teach/www/rmd_nav_newCodeChunk.png){width="60px"}</td>
    <td>new code chunk (R, Bash, D3, Python, etc.)</td>
  </tr>
  <tr>
    <td>![](https://raw.githubusercontent.com/zoometh/thomashuet/master/teach/www/rmd_nav_run.png){width="60px"}</td>
    <td>run a part or the whole document</td>
  </tr>
  <tr>
    <td>![](https://raw.githubusercontent.com/zoometh/thomashuet/master/teach/www/rmd_nav_publish.png){width="60px"}</td>
    <td>publish the document</td>
  </tr>
  <tr>
    <td>![](https://raw.githubusercontent.com/zoometh/thomashuet/master/teach/www/rmd_nav_visualMdEditor.png){width="60px"}</td>
...
```{=html}
<iframe width="900" height="400" src="https://tableconvert.com/" title="Online table convertor"></iframe>
```
