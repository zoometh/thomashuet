...
|-------------|-----------------|-----------------|-------------------------------------|------------------------------------|------------------------------------|------------------------------------|------------------------------------|------------------------------------|
| <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-prg-python.png' style='height: 45px;vertical-align: middle;'>
      | Large and diverse | Relatively easy  | Strong support  | Blender, libraries[^1] | Leading language[^2] | Leading language[^8] | Jupyter Notebook                                  | Popular frameworks[^4] |
| <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-prg-java.png' style='height: 45px;vertical-align: middle;'>
        | Large and established | Moderate  | Limited   | Java 3D API   | Used in enterprise | Java-based tools available  | Apache POI                                  | Various frameworks[^5] |
| <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-prg-js.png' style='height: 45px;vertical-align: middle;'>
  | Ubiquitous in web dev | Easy for web dev | Limited | WebGL | web-based apps | Limited  | D3.js                                  | Numerous frameworks[^6] |
| <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-prg-matlab.png' style='height: 45px;vertical-align: middle;'>
      | Academia, industry | Steeper  | Comprehensive support | Poor texture mapping | Academia, industry | Limited   |  Live scripts but hard to share  | Limited   |
...
Complex tables have to be created inside code chunks, e.g. [kable()](https://bookdown.org/yihui/rmarkdown-cookbook/kable.html) from {`knitr`} with [kable_styling()](https://cran.r-project.org/web/packages/kableExtra/vignettes/awesome_table_in_html.html) from {`kableExtra`}
