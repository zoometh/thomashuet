...
<span class="r-md">R Markdown</span> allows **Literate programming** (LPs)[^0]. It combines R code chunks and narrative parts with -- mainly -- Markdown syntax
...
[^0]: _syn._: Authoring Framework for Data Science (AFDS), or Executable Publication.
...
::: {.callout-note}
See the [code source](https://github.com/zoometh/thomashuet/blob/0d6932cd4e7a618fd6dc8c96f0aec62ca852d92b/teach/stats/r4a/2026/index-part1.qmd#L108-L115)
:::


### LPs

LPs are used to create data-driven documents (reports) from a notebook interface
...
A <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-prg-r-quarto-2.png' style='height: 45px;vertical-align: middle;'> Quarto document (`.qmd`) -- useful for publishing online presentations, wikis and books --  using <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-web-js-revealjs-1.png' style='height: 45px;vertical-align: middle;'> reveal.js (<img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-prg-js.png' style='height: 45px;vertical-align: middle;'>) hosted on <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/github.png' style='height: 45px;vertical-align: middle;'> GitHub ([here](https://github.com/zoometh/thomashuet/blob/main/teach/stats/r4a/2026/index-part1.qmd)), prepared in RStudio (*aka* posit).
...
<img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/inst-inrap-archeozoologie-ex2.jpg' style='height: 330px;vertical-align: middle;'>
<div class="captiontext">L'archéozoologie &copy; Inrap</div>
...
<img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-pao-markdown-ex-report-html.png' style='height: 350px;vertical-align: middle;'>
...
* cross-referencing[^504], <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-pao-latex.png' style='height: 45px;vertical-align: middle;'> writing and <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-pao-bibtex.png' style='height: 45px;vertical-align: middle;'> bibliographic references could be done using [bookdown](https://bookdown.org/) <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/r-pkg-bookdown.png' style='width: 45px;vertical-align: middle;'>
* interactive maps, 3D plots, etc.

[^504]: one that refers the reader to information that's located somewhere else in the same book.
...
<tbody>
  ...
  <tr>
    ...
    <td>[rmarkdown](https://cran.r-project.org/web/packages/rmarkdown/index.html) is an extension of [knitr](https://yihui.org/knitr/) to convert <span class="r-md">R Markdown</span> documents into a variety of formats</td>
  </tr>
    <tr>
...
<div class="captiontext">A new document is created.</div>
...
<small><https://github.com/zoometh/thomashuet/blob/main/teach/stats/r4a/2026/temp.Rmd></small>
...
<tbody>
  <tr>
    ...
    <td>`knit` <img src="https://raw.githubusercontent.com/zoometh/thomashuet/master/img/r-pkg-knitr.png" style="height: 40px;vertical-align: middle;"/>automatically when saving the document</td>
  </tr>
  <tr>
...
:::: {.columns}
::: {.column width="40%"}
<span class="r-md">R Markdown</span> combines<br>

<div class="div-yaml"> 
<small>header YAML</small><br>
<img src="https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-prg-yaml-1.png" style="height: 45px;vertical-align: middle;"/> [YAML header](https://zoometh.github.io/thomashuet/teach/stats/r4a/2026/site/index-part2#/yaml)
</div>

<div class="div-code"> 
<small>code chunk</small><br>
<img src="https://raw.githubusercontent.com/zoometh/thomashuet/master/img/prog-r-1.png" style="height: 45px;vertical-align: middle;"/> [code chunks](https://zoometh.github.io/thomashuet/teach/stats/r4a/2026/site/index-part2#/chunks)
</div>

<div class="div-text"> 
<small>narrative part</small><br>
<img src="https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-pao-markdown-2.png" style="height: 45px;vertical-align: middle;"/> [narrative parts](#text)
</div>
...
| Markdown (<img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-pao-latex.png' style='height: 45px;vertical-align: middle;'>)                  | Rendered                 |
|----------------------------|--------------------------|
| `$$\sum_{i=1}^{n} X^3_i$$` | $$\sum_{i=1}^{n} X^3_i$$ |
| `$$\Delta S \ge 0$$`       | $$\Delta S \ge 0$$       |
| ...                        | ...                      |
...
- Unnumbered
  * first element
  * second element
    - second element - sub 1
      + second element - sub 1 - subsub 1
      + second element - sub 1 - subsub 2
```
</div>
...
| Left             |    Center           |         Right |
| :---             |    :----:           |          ---: |
| Long Header      | My Very Long Title  | Hello World   |
```
</div>
...
To be created in <span class="r-code">code chunks</span>
...
<small>narrative part</small><br>
```{.md }
![](C:/Users/TH282424/Rprojects/thomashuet/teach/www/logo.png){width=100px}
```
</div>
...
<small>narrative part</small><br>
```{.md }
<img src="C:/Users/TH282424/Rprojects/thomashuet/teach/www/logo.png" alt="logo" width=100>  
```
</div>
...
- `&emsp;` = 4 spaces (i.e., a tabulation)
- `&ensp;` = 2 spaces
- `&nbsp;` = 1 space
...
Lorem ipsum dolor sit amet, etc. (**see [My Header level 3](#bookmarks)). 
...
<small>narrative part</small><br>
```{.md }
part 2: [Practice](https://github.com/zoometh/thomashuet/tree/main/teach/stats/r4a/2026/2_R Markdown_Practice)
```
</div>
part 2: [Practice](https://github.com/zoometh/thomashuet/tree/main/teach/stats/r4a/2026/2_R Markdown_Practice)
...
<small>narrative part</small><br>
```{.html }
<a href="https://www.mappalab.eu/en/2021/01/04/r4-archaeologists-winter-school-deadline-postponed/" target="_blank">
...
<div class="div-text"> 
<small>narrative part</small><br>
```{.md code-line-numbers="1|3|4"}
A simple footnote[^66] and a second one[^3]

[^66]: This is a first footnote.
[^3]: This is a second footnote.
```
</div>
...
::: {.callout-note}
Footnotes numbering is automatically sorted and incremented. Footnotes can be placed virtually everywhere (check [this example](https://github.com/zoometh/thomashuet/blob/695e1c0198c989774e4a117bf520d28089c9b158/teach/stats/r4a/2026/index-part1.qmd#L1052-L1059))
:::
...
Variables calculated within <span class="r-code">code chunks</span>
...
can be called in the <span class="r-text">narrative parts</span>, for example `number.of.axes`
...
```{r maxLmaxB, echo=FALSE, fig.cap= "Axes L/B ratio"}
#| out-width: "60%"
...
<img src="https://raw.githubusercontent.com/zoometh/thomashuet/master/teach/www/rmd_bib.png" alt="rmd_bib" width="900"/>
...
[Here](https://zoometh.github.io/thomashuet/teach/stats/r4a/2026/site/index-part2#/title-slide)
