...
![quantitative](images/stat-scale-quant.png){width=200px}

![ordinal](images/stat-scale-ord.png){width=200px}

![nominal](images/stat-scale-nom.png){width=200px}

![bimodal](images/stat-scale-bimod.png){width=200px}
