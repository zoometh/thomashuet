...
<div class="row">
  ...
  ⚠️ In practice, over-valuing a specific element by giving it a marker character is very dangerous, as its very originality makes its management uncontrollable.</div>
</div>
...
<div class="row">
  <div class="column">![](images/who-obama.jpg)</div>
...
<p>
 R is the 1️⃣<sup>st</sup> programming language used by archaeologists, and the 18<sup>t/<sup> worldwide<small>- [Tiobe index 2022](https://www.tiobe.com/tiobe-index/) + [Batist, Roe, 2022](https://youtu.be/tUhHhzGSgbk?t=7499)</small>
</p>
:::
