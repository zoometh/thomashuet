...
```{r munsingenfib, echo=TRUE, fig.width = 7, fig.align="center", fig.cap= "Fibulae measurements (Hodson, 1970)"}
...
Maps with {`leaflet`} package <img src="https://raw.githubusercontent.com/zoometh/thomashuet/master/img/r-pkg-leaflet.png" style="height: 40px;vertical-align: middle;"/>
...
2D plots with the {`plotly`} package <img src="https://raw.githubusercontent.com/zoometh/thomashuet/master/img/r-pkg-plotly.png" style="height: 40px;vertical-align: middle;"/>
...
```{=html}
<iframe width="780" height="400" src="https://rmarkdown.rstudio.com/lesson-9.html"></iframe>
```
