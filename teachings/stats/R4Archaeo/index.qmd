...
R Markdown extension is `.Rmd`:  <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-r.png' style='height: 40px;vertical-align: middle;'> + `md` for Markdown
