...
<br> <center> gives the same result 🗘 : </center> <br>
...
Complex tables needs are created in code chunks, e.g. [kable()](https://bookdown.org/yihui/rmarkdown-cookbook/kable.html) from {`knitr`} with [kable_styling()](https://cran.r-project.org/web/packages/kableExtra/vignettes/awesome_table_in_html.html) from {`kableExtra`}
...
`## Practice`[^2] has the anchor `#practice-anchor` inside curly brackets:
...
Variables calculated inside the code chunks can be called in the narrative part: <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/teachings/stats/R4Archaeo/www/rmd_call_var.png' style='height: 45px;vertical-align: middle;'>
