...
In this R Markdown document  
  ...
  - Overall duration estimation: 75 min
...
````md
```
Mardown + Descriptive statistics ca (20 minutes)  
  - Adapt the title  
...
````md
```
Mardown + Exploratory statistics ca (20 minutes)__  
  - Adapt the title  
...
````md
```
Mardown + Confirmatory statistics ca (20 minutes)__  
  - Adapt the title  
