...
```{=html}
<iframe width="780" height="500" src="https://zoometh.github.io/thomashuet/teachings/stats/_stats/dim2/oxfordwater" title="Quarto Documentation"></iframe>
```
...
<div class="column">
<center>![✔️ Fitting](images/mod-fitting.png){height=300px}</center><br>
<center>![❌ Fitting](images/mod-fittingnot-a.png){height=300px}</center>
</div>
...
<div class="column">
<center>![bblblb](images/mod-regularity-christaller.jpg){height=300px}</center>
</div>
...
<div class="column">
<center>![bblblb](images/mod-robust.jpg){height=300px}</center>
</div>
...
<div class="column">
<center>![bblblb](images/mod-parsimony-laplace.jpg){height=300px}</center>
</div>
...
<div class="column">
<center>![bblblb](images/mod-versioning.jpg){height=300px}</center>
</div>
...
<td>Working data (i.e. not definitive)</td>
</tr>
<tr>
<td>Aggregated data</td>
<td>Gathered data expressed in a summary form</td>
</tr>
<tr>
<td>Metadata</td>
...
<tr>
<td>Missing data</td>
<td>Lack of knowledge, eg. `NA` (<em>Not Available</em>)</td>
</tr>
</tbody>
</table>
...
Random <em>versus</em> clustered patterns
