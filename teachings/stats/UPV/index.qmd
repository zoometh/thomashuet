...
<div class="column">
<center>![✔️ Fitting](images/mod-fitting.png){height=300px}</center></div>
<center>![❌ Fitting](images/mod-fittingnot-a.png)height=300px}</center></div>
</div>
...
<div class="column">
<center>![bblblb](images/mod-regularity-christaller.jpg){height=300px}</center></div>
</div>
...
<div class="column">
<center>![bblblb](images/mod-robust.jpg){height=300px}</center></div>
</div>
...
<div class="column">
<center>![bblblb](images/mod-parsimony-laplace.jpg){height=300px}</center></div>
</div>
...
<div class="column">
<center>![bblblb](images/mod-versioning.jpg){height=300px}</center></div>
</div>
