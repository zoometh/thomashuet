...
<div class="column">We want to compare groups of settlement of 3 different cultures (or sites): <br>
<ul>
<li><span style="color:blue">A</span></li>
<li><span style="color:red">B</span></li>
<li><span style="color:green">C</span></li>
</ul>
</div>
</div>
...
datatable(df, 
          ...
          options = list(searching = FALSE,
                         ...
                         PageLength = 3,
                         scrollX = F,
                         initComplete = JS("function(settings, json) {$(this.api().table().header()).css({'font-size' : '24px'});}"),
                         info = FALSE,
...
```{=html}
<iframe width="1000" height="500" src="https://zoometh.github.io/thomashuet/teachings/stats/_stats/dim2/oxfordwater" title="Regression"></iframe>
```
...
<div class="row">
<div class="column"><center>![George E. P. Box](../images/aut-box.jpg){height=300px}</center></div>
...
<div class="column">
<center>![✔️ Fitting](../images/mod-fitting.png){height=250px}</center><br>
</div>

<div class="column">
<center>![❌ Fitting](../images/mod-fittingnot-a.png){height=250x}</center>
</div>
...
d <- datatable(Mesolithic, 
          caption = "British Mesolithic assemblages (%)",
          options = list(initComplete = JS("function(settings, json) {$(this.api().table().header()).css({'font-size' : '24px'});}"))
)
print(d)
```
...
print(paste0("<b>Caption-Abstract</b>: ", img[["Caption-Abstract"]]))
print(paste0("<b>Copyright</b>: ", img[["Copyright"]]))
```


### Missing

Missing data (`NA`, <em>Not Available</em>)<br>
