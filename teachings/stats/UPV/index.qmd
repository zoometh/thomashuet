...
<div class="captiontext">Natural language processing (NLP), prompted text with ChatGPT, 2023</div>
</div>
...
<div class="captiontext">Computer vision, Deep Neural Network model</div>
</div>
...
<br>
<li>Coefficient of determination 
<ul class="square">
...
## 2-dim data spatial {background-iframe="http://shinyserver.cfs.unipi.it:3838/teach/stats/stats/pointbasic/"}
...
## 2-dim data spatial {background-iframe="http://shinyserver.cfs.unipi.it:3838/teach/stats/stats/pointpattern/"}
