...
format:
  revealjs: 
    ...
    css: styles.css
    footer: "Statistics in Archaeology <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/inst-asm-cnrs.png' style='height: 45px;vertical-align: middle;'> CNRS ASM, Université Paul-Valéry, Feb 2023 - Thomas Huet <https://tinyurl.com/stats-upv>"
    # margin: -0.5
    margin: 0
    width: 1200
resources:
...
<div class="row">
<div class="column"><center>![](../images/conformity-singularity.png){height=350px}</center></div>
...
<div class="row">
<div class="column"><center>![](../images/conformity-conformity.png){height=350px}</center></div>
...
<div class="row">
<div class="column"><center>![](../images/conformity-identity.png){height=350px}</center></div>
