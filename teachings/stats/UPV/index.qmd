...
format:
  revealjs: 
    ...
    css: styles.css
    footer: "Statistics & Computer Scripts in Archaeology, UPV 2022 - T. Huet - <https://tinyurl.com/stats-upv>"
    # margin: -0.5
    margin: 0
    width: 1200
resources:
...
```{r}
img <- exiftoolr::exif_read("C:/Rprojects/thomashuet/teachings/stats/UPV/images/data-meta-photo-microliths.jpg")
