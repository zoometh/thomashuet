...
format:
  revealjs: 
    ...
    css: styles.css
    footer: "Statistics & Computer Scripts in Archaeology, Oxford MT2 2022 - T. Huet - <https://tinyurl.com/goa-oxford>"
    # margin: -0.5
resources:
  - demo.pdf
...
datatable(df, 
  ...
  formatStyle(
    "feat",
    columns = colnames(.), fontSize = '50%', # fontSize = '20%',
...
<td>![](../_images/mod-fitting.png){height=200px}</td>
</tr>
<tr>
<td>Regularity</td>
